...
export class ApiService {
  ...
  async getpropostaById(id: number): Promise<any> {
    ...
    const response: any = await 
        this.http.get<any>(`https://sb-api.portocred.com.br/credito-pessoal-demo/v1/propostas/${id}`, {headers: headers}).toPromise()
